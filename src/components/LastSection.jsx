	...
	return (
		<section className=' flex justify-center items-center p-20'>
			<div className='flex flex-col justify-center items-center gap-5'>
				...
				<p className='text-4xl text-white font-semibold'>Embrace the new era of outbound.</p>
				<p className='text-text w-[650px] text-center'>Wizia lets you train, activate, and optimize aiDRs. 
